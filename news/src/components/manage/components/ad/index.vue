<template>
  <el-container>
    ...
    <el-container>
      <el-main>
          <hourline :series="series" :legend='legend' :xaxis='xaxis' title="广告分析"/>
      </el-main>
    </el-container>
    <el-footer></el-footer>
  </el-container>
...
export default {
  ...
  methods:{
    ...
    getWhole(){
      ...
      var _this = this;
       axios.get(`/v1/adCount?start_time=${start_time}&end_time=${end_time}`)
      .then(function (response) {
        var res = response.data;
        var dateArr = _this.getDataArrByCol(res,'date');
        var adArr = _this.getDataArrByCol(res,'ad_visit_sum');
